...
export default function PvcCatalogSection({ collections, products }) {
    ...
    <section className="space-y-8 lg:space-y-10">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <SectionHeading
          ...
          title="Explore PVC laminate shades for textured, glossy, wood, stone, and soft-touch interiors"
          description="Browse fluted designs, marble-inspired slabs, wood textures, metallic tones, shimmer finishes, and contemporary pastel surfaces, then preview how each sheet reads in a styled interior setting."
        />
              ...
              <div className="relative rounded-[26px] border border-[#ece0d5] bg-[#f7f0e8] p-3">
                <div className="relative h-[320px] rounded-[20px] bg-white/35 p-2 sm:h-[420px] xl:h-[min(68vh,720px)]">
                  <Image
                    ...
                    alt={`${activeProduct.name} PVC laminate application preview`}
                    fill
        ...
        <div className="grid gap-4 sm:grid-cols-2 2xl:grid-cols-3">
          {filteredProducts.map((product, index) => {
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden rounded-[22px] border border-[#ece0d5] bg-[linear-gradient(180deg,#fff,#f5ede3)]">
                  <div className="relative aspect-[4/5]">
                    ...
                    />
                    <div className="pointer-events-none absolute inset-y-0 -left-1/2 w-1/2 rotate-[16deg] bg-white/45 opacity-0 blur-2xl transition duration-700 group-hover:translate-x-[320%] group-hover:opacity-100" />
                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#1f1915]/58 via-transparent to-transparent p-4">
